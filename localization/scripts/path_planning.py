        ...
        while not rospy.is_shutdown():
            ...
            if self.goal_msg!= None:
                ...
                for i in range(len(path_px)):
                    ...
                    self.localization_msg.pose.position.x = (self.x*(-0.01))+0.5 # # Converting into meter because rviz grid/ drone world works in meter; our world res is in cm and origin is 0.5 instead of 10
                    self.localization_msg.pose.position.y = (self.y*(-0.01))+0.5 # # Converting into meter because rviz grid/ drone world works in meter
                    self.localization_msg.pose.position.z = 0*(0.01) # # Converting into meter because rviz grid/ drone world works in meter
                    
                    self.localization_msg.pose.orientation.x = 0*(0.01) # # Converting into meter because rviz grid/ drone world works in meter
                    self.localization_msg.pose.orientation.y = 0*(0.01) # # Converting into meter because rviz grid/ drone world works in meter
                    self.localization_msg.pose.orientation.z = 0*(0.01) # # Converting into meter because rviz grid/ drone world works in meter
                    self.localization_msg.pose.orientation.w = 0*(0.01) # # Converting into meter because rviz grid/ drone world works in meter
