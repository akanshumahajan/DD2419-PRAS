...
def create_grid(json_dict, grid_res=10):
    ...
    offset = json_dict['airspace']['min'][:2]       #[-10 , -10]
    max_point = json_dict['airspace']['max'][:2]    # [10 , 10]
...
def read_json(path = '/home/akanshu/dd2419_ws/src/course_packages/dd2419_resources/worlds_json/tutorial_1.world.json'):
    with open(path) as f:
