...
class ArucoDetect:
    ...
    def __init__(self):
        ...
        self.aruco_pos_topic = rospy.get_param(param2)
    ...
    def aruco_calc_tf(self, marker):
        ...
        self.transform.header.stamp = self.marker_odom_frame.header.stamp
        self.transform.header.frame_id = self.odom_frame
        self.transform.child_frame_id = "aruco/detected" + str(marker.id)
    
        self.transform.transform.translation = self.marker_odom_frame.pose.position
        self.transform.transform.rotation = self.marker_odom_frame.pose.orientation
