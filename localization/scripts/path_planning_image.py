...
class Pathplanning:
    ...
    def goal_position(self, x_map = -0.1, y_map = 0.4):
        ...
        if not self.tfBuffer.can_transform('image', 'cf1/base_link', rospy.Time.now(), rospy.Duration(1.0)):
    ...
    def start_position(self):
        ...
        try:
            ...
            rospy.loginfo('Goal Transform: Lookup transfrom from map to image is available')
            trans_bool = True
